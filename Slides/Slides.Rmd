...
.pull-left[**DESeq2**
```{r, out.width="350px", fig.align='center'}
knitr::include_graphics("./Images/PCADESeq2.png")
```
]
--
.pull-right[**PCA tools**
```{r, out.width="350px", fig.align='center'}
knitr::include_graphics("./Images/PCAtools.png")
```
]
...
knitr::include_graphics("./Images/ScreeplotPCAtools.png")
```
...
```{r, out.width="600px", fig.align='center'}
knitr::include_graphics("./Images/MAplotDESeq.png")
```
...
```{r, out.width="350px", fig.align='center'}
knitr::include_graphics("./Images/MAplotlfc.png")
```
]
---
# MAplot
...
```{r, eval = F, echo = T}
##Para los objetos creados con DESeq2 es importante que incluyas un nivel llamado group al objeto dds
...
```{r, out.width="600px", fig.align='center'}
knitr::include_graphics("./Images/VolcanoplotDESeq.png")
```
...
```{r, out.width="650px", fig.align='center'}
knitr::include_graphics("./Images/HeatmapDESeq.png")
```
